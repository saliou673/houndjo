...
export const Skeleton = React.memo(function Skeleton({
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/immutability -- Reanimated shared values are mutated via `.value` by design; the compiler-oriented rule doesn't recognize that escape hatch.
